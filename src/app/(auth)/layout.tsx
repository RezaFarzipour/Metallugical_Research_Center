...
import DemoHintToast from "@/components/module/DemoHintToast";
...
export default function AuthLayout({ children }: AuthLayoutProps) {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-secondary-50 overflow-hidden">
      <div className="relative flex flex-col lg:flex-row w-full h-full">
        ...
        {/* نمایش Toast فقط در استپ اول */}
        {currentStep === 1 && <DemoHintToast />}

        {/* باکس فرم */}
        <div className="bg-transparent flex lg:block items-center justify-center h-full lg:min-h-fit lg:absolute lg:top-28 2xl:top-40 lg:right-48 xl:right-48 2xl:right-96 z-10 w-full p-4">
        ...
        {/* باکس تصویر و استپر - فقط در دسکتاپ */}
        <div className="hidden lg:block w-3/5 bg-blue-500 h-full absolute top-0 left-0 overflow-hidden">
          <Image
        ...
        <div className="absolute top-[16rem] right-[16rem] block lg:hidden">
          <BgAnimateShape animation="animate-blink" />
        </div>
      </div>
    </div>
