...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-stretch text-center lg:text-right p-6 lg:p-10 gap-10 lg:gap-12  md:justify-between">
  {/* دسترسی سریع */}
  <div className="flex flex-col gap-4 items-start md:items-center text-center md:text-left">
  ...
  {/* راه‌های ارتباطی */}
  <div className="flex gap-4 flex-col items-start md:items-center text-center md:text-right mb-6">
    <p className="font-bold text-default-900 text-lg lg:text-xl">
      راه‌های ارتباطی
    </p>
