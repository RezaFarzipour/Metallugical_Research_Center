...
export const createServiceSchema = z.object({
    service_name: z
        ...
        .regex(persianRegex, "نام محصول باید فقط به زبان فارسی باشد"),  // فقط کاراکترهای فارسی مجاز هستند

    description: z
        .string()
        .min(5, "توضیحات باید حداقل ۵ کاراکتر داشته باشد")
        .max(500, "توضیحات خیلی طولانی است")
        .regex(persianRegex, "توضیحات باید فقط به زبان فارسی باشد"),  // فقط کاراکترهای فارسی مجاز هستند
